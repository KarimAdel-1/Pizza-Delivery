...
function Button({ children, disabled, to, type }) {
  ...
  const styles = {
    ...
    small: base + ' px-4 py-2 md:px-5 md:py-2.5 text-xs cursor-pointer',
    secondary:
      'text-sm px-4 py-2.5 md:px-6 md:py-3.5 inline-block rounded-full border-2 border-stone-300 font-semibold uppercase tracking-wide text-stone-400 transition-colors duration-300 hover:bg-stone-300 focus:bg-stone-300 hover:text-stone-800 focus:text-stone-300 focus:outline-none focus:ring focus:ring-stone-200 focus:ring-offset-2 disabled:cursor-not-allowed cursor-pointer',
  };
